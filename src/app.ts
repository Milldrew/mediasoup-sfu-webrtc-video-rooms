...
io.on('connection', (socket: any) => {
  ...
  socket.on('connectTransport', async ({ transport_id, dtlsParameters }: { transport_id: string; dtlsParameters: any }, callback: (result: string) => void) => {
  ...
  socket.on('produce', async ({ kind, rtpParameters, producerTransportId }: { kind: string; rtpParameters: any; producerTransportId: string }, callback: (result: any) => void) => {
  ...
  socket.on('consume', async ({ consumerTransportId, producerId, rtpCapabilities }: { consumerTransportId: string; producerId: string; rtpCapabilities: any }, callback: (result: any) => void) => {
    //TODO null handling
